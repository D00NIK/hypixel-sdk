...
import type {
  ...
  RecentgamesGet200Response,
  RecentgamesGet422Response,
  StatusGet200Response,
} from '../models';
import {
    GuildGet200ResponseFromJSON,
    GuildGet200ResponseToJSON,
    PlayerGet200ResponseFromJSON,
    PlayerGet200ResponseToJSON,
    ...
    RecentgamesGet200ResponseFromJSON,
    RecentgamesGet200ResponseToJSON,
    RecentgamesGet422ResponseFromJSON,
    RecentgamesGet422ResponseToJSON,
    StatusGet200ResponseFromJSON,
    StatusGet200ResponseToJSON,
} from '../models';
...
export interface RecentgamesGetRequest {
    uuid: string;
}
 ...
 * 
 */
export class PlayerDataApi extends runtime.BaseAPI {

    /**
     * Retrieve a Guild by a player, id, or name
     */
    async guildGetRaw(requestParameters: GuildGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GuildGet200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GuildGet200ResponseFromJSON(jsonValue));
    }

    /**
     * Retrieve a Guild by a player, id, or name
     */
    async guildGet(requestParameters: GuildGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GuildGet200Response> {
        const response = await this.guildGetRaw(requestParameters, initOverrides);
     ...
     */
    async playerGetRaw(requestParameters: PlayerGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PlayerGet200Response>> {
        if (requestParameters.uuid === null || requestParameters.uuid === undefined) {
            throw new runtime.RequiredError('uuid','Required parameter requestParameters.uuid was null or undefined when calling playerGet.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PlayerGet200ResponseFromJSON(jsonValue));
    }

    /**
     * Data of a specific player, including game stats
     */
    async playerGet(requestParameters: PlayerGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PlayerGet200Response> {
        const response = await this.playerGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async recentgamesGetRaw(requestParameters: RecentgamesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecentgamesGet200Response>> {
        if (requestParameters.uuid === null || requestParameters.uuid === undefined) {
            throw new runtime.RequiredError('uuid','Required parameter requestParameters.uuid was null or undefined when calling recentgamesGet.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RecentgamesGet200ResponseFromJSON(jsonValue));
    }

    /**
     * The recently played games of a specific player
     */
    async recentgamesGet(requestParameters: RecentgamesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecentgamesGet200Response> {
        const response = await this.recentgamesGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async statusGetRaw(requestParameters: StatusGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StatusGet200Response>> {
        if (requestParameters.uuid === null || requestParameters.uuid === undefined) {
            throw new runtime.RequiredError('uuid','Required parameter requestParameters.uuid was null or undefined when calling statusGet.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => StatusGet200ResponseFromJSON(jsonValue));
    }

    /**
     * The current online status of a specific player
     */
    async statusGet(requestParameters: StatusGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StatusGet200Response> {
        const response = await this.statusGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
