...
/**
 * Check if a given object implements the ActiveBooster interface.
 */
export function instanceOfActiveBooster(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActiveBoosterFromJSON(json: any): ActiveBooster {
    return ActiveBoosterFromJSONTyped(json, false);
}

export function ActiveBoosterFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActiveBooster {
...
export function ActiveBoosterToJSON(value?: ActiveBooster | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
