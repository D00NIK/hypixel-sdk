 ...
 * 
 * @export
 * @interface ActiveBoosterAllOf
 */
export interface ActiveBoosterAllOf {
    /**
     * 
     * @type {Array<string>}
     * @memberof ActiveBoosterAllOf
     */
    stacked?: Array<string> | null;
}

/**
 * Check if a given object implements the ActiveBoosterAllOf interface.
 */
export function instanceOfActiveBoosterAllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActiveBoosterAllOfFromJSON(json: any): ActiveBoosterAllOf {
    return ActiveBoosterAllOfFromJSONTyped(json, false);
}

export function ActiveBoosterAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActiveBoosterAllOf {
...
export function ActiveBoosterAllOfToJSON(value?: ActiveBoosterAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
