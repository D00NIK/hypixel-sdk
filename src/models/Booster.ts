...
/**
 * Check if a given object implements the Booster interface.
 */
export function instanceOfBooster(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BoosterFromJSON(json: any): Booster {
    return BoosterFromJSONTyped(json, false);
}

export function BoosterFromJSONTyped(json: any, ignoreDiscriminator: boolean): Booster {
...
export function BoosterToJSON(value?: Booster | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
