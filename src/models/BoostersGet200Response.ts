...
import type { BoostersGet200ResponseBoosterState } from './BoostersGet200ResponseBoosterState';
import {
    BoostersGet200ResponseBoosterStateFromJSON,
    BoostersGet200ResponseBoosterStateFromJSONTyped,
    BoostersGet200ResponseBoosterStateToJSON,
} from './BoostersGet200ResponseBoosterState';
import type { BoostersGet200ResponseBoostersInner } from './BoostersGet200ResponseBoostersInner';
import {
    BoostersGet200ResponseBoostersInnerFromJSON,
    BoostersGet200ResponseBoostersInnerFromJSONTyped,
    BoostersGet200ResponseBoostersInnerToJSON,
} from './BoostersGet200ResponseBoostersInner';

/**
 * 
 * @export
 * @interface BoostersGet200Response
 */
export interface BoostersGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof BoostersGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<BoostersGet200ResponseBoostersInner>}
     * @memberof BoostersGet200Response
     */
    boosters?: Array<BoostersGet200ResponseBoostersInner>;
    /**
     * 
     * @type {BoostersGet200ResponseBoosterState}
     * @memberof BoostersGet200Response
     */
    boosterState?: BoostersGet200ResponseBoosterState;
}

/**
 * Check if a given object implements the BoostersGet200Response interface.
 */
export function instanceOfBoostersGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BoostersGet200ResponseFromJSON(json: any): BoostersGet200Response {
    return BoostersGet200ResponseFromJSONTyped(json, false);
}

export function BoostersGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoostersGet200Response {
    ...
    return {
        ...
        'boosters': !exists(json, 'boosters') ? undefined : ((json['boosters'] as Array<any>).map(BoostersGet200ResponseBoostersInnerFromJSON)),
        'boosterState': !exists(json, 'boosterState') ? undefined : BoostersGet200ResponseBoosterStateFromJSON(json['boosterState']),
    };
}

export function BoostersGet200ResponseToJSON(value?: BoostersGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'boosters': value.boosters === undefined ? undefined : ((value.boosters as Array<any>).map(BoostersGet200ResponseBoostersInnerToJSON)),
        'boosterState': BoostersGet200ResponseBoosterStateToJSON(value.boosterState),
    };
}
