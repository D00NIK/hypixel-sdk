 ...
 * 
 * @export
 * @interface BoostersGet200ResponseBoosterState
 */
export interface BoostersGet200ResponseBoosterState {
    /**
     * 
     * @type {boolean}
     * @memberof BoostersGet200ResponseBoosterState
     */
    decrementing?: boolean;
}

/**
 * Check if a given object implements the BoostersGet200ResponseBoosterState interface.
 */
export function instanceOfBoostersGet200ResponseBoosterState(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BoostersGet200ResponseBoosterStateFromJSON(json: any): BoostersGet200ResponseBoosterState {
    return BoostersGet200ResponseBoosterStateFromJSONTyped(json, false);
}

export function BoostersGet200ResponseBoosterStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoostersGet200ResponseBoosterState {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'decrementing': !exists(json, 'decrementing') ? undefined : json['decrementing'],
    };
}

export function BoostersGet200ResponseBoosterStateToJSON(value?: BoostersGet200ResponseBoosterState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'decrementing': value.decrementing,
    };
}
