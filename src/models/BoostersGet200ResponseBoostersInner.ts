...
import {
    ActiveBooster,
    instanceOfActiveBooster,
    ActiveBoosterFromJSON,
    ActiveBoosterFromJSONTyped,
    ActiveBoosterToJSON,
} from './ActiveBooster';
import {
    QueuedBooster,
    instanceOfQueuedBooster,
    QueuedBoosterFromJSON,
    QueuedBoosterFromJSONTyped,
    QueuedBoosterToJSON,
} from './QueuedBooster';

/**
 * @type BoostersGet200ResponseBoostersInner
 * 
 * @export
 */
export type BoostersGet200ResponseBoostersInner = ActiveBooster | QueuedBooster;

export function BoostersGet200ResponseBoostersInnerFromJSON(json: any): BoostersGet200ResponseBoostersInner {
    return BoostersGet200ResponseBoostersInnerFromJSONTyped(json, false);
}

export function BoostersGet200ResponseBoostersInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BoostersGet200ResponseBoostersInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...ActiveBoosterFromJSONTyped(json, true), ...QueuedBoosterFromJSONTyped(json, true) };
}

export function BoostersGet200ResponseBoostersInnerToJSON(value?: BoostersGet200ResponseBoostersInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfActiveBooster(value)) {
        return ActiveBoosterToJSON(value as ActiveBooster);
    }
    if (instanceOfQueuedBooster(value)) {
        return QueuedBoosterToJSON(value as QueuedBooster);
    }
