 ...
 * 
 * @export
 * @interface CountsGet200Response
 */
export interface CountsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof CountsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the CountsGet200Response interface.
 */
export function instanceOfCountsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CountsGet200ResponseFromJSON(json: any): CountsGet200Response {
    return CountsGet200ResponseFromJSONTyped(json, false);
}

export function CountsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountsGet200Response {
    ...
    return {
        ...
        'games': !exists(json, 'games') ? undefined : json['games'],
    };
}

export function CountsGet200ResponseToJSON(value?: CountsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
