 ...
 * 
 * @export
 * @interface GuildGet200Response
 */
export interface GuildGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GuildGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the GuildGet200Response interface.
 */
export function instanceOfGuildGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GuildGet200ResponseFromJSON(json: any): GuildGet200Response {
    return GuildGet200ResponseFromJSONTyped(json, false);
}

export function GuildGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GuildGet200Response {
...
export function GuildGet200ResponseToJSON(value?: GuildGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
