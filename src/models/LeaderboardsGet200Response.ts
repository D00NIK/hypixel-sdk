...
/**
 * Check if a given object implements the LeaderboardsGet200Response interface.
 */
export function instanceOfLeaderboardsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LeaderboardsGet200ResponseFromJSON(json: any): LeaderboardsGet200Response {
    return LeaderboardsGet200ResponseFromJSONTyped(json, false);
}

export function LeaderboardsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaderboardsGet200Response {
    ...
    return {
        ...
        'leaderboards': !exists(json, 'leaderboards') ? undefined : json['leaderboards'],
    };
}

export function LeaderboardsGet200ResponseToJSON(value?: LeaderboardsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
