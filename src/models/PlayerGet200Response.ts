...
import type { PlayerGet200ResponsePlayer } from './PlayerGet200ResponsePlayer';
import {
    PlayerGet200ResponsePlayerFromJSON,
    PlayerGet200ResponsePlayerFromJSONTyped,
    PlayerGet200ResponsePlayerToJSON,
} from './PlayerGet200ResponsePlayer';

/**
 * 
 * @export
 * @interface PlayerGet200Response
 */
export interface PlayerGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof PlayerGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {PlayerGet200ResponsePlayer}
     * @memberof PlayerGet200Response
     */
    player?: PlayerGet200ResponsePlayer;
}

/**
 * Check if a given object implements the PlayerGet200Response interface.
 */
export function instanceOfPlayerGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerGet200ResponseFromJSON(json: any): PlayerGet200Response {
    return PlayerGet200ResponseFromJSONTyped(json, false);
}

export function PlayerGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerGet200Response {
    ...
    return {
        ...
        'player': !exists(json, 'player') ? undefined : PlayerGet200ResponsePlayerFromJSON(json['player']),
    };
}

export function PlayerGet200ResponseToJSON(value?: PlayerGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'player': PlayerGet200ResponsePlayerToJSON(value.player),
    };
}
