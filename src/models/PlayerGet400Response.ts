 ...
 * 
 * @export
 * @interface PlayerGet400Response
 */
export interface PlayerGet400Response {
    /**
     * 
     * @type {boolean}
     * @memberof PlayerGet400Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the PlayerGet400Response interface.
 */
export function instanceOfPlayerGet400Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerGet400ResponseFromJSON(json: any): PlayerGet400Response {
    return PlayerGet400ResponseFromJSONTyped(json, false);
}

export function PlayerGet400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerGet400Response {
...
export function PlayerGet400ResponseToJSON(value?: PlayerGet400Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
