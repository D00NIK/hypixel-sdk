 ...
 * 
 * @export
 * @interface PlayerGet403Response
 */
export interface PlayerGet403Response {
    /**
     * 
     * @type {boolean}
     * @memberof PlayerGet403Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the PlayerGet403Response interface.
 */
export function instanceOfPlayerGet403Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerGet403ResponseFromJSON(json: any): PlayerGet403Response {
    return PlayerGet403ResponseFromJSONTyped(json, false);
}

export function PlayerGet403ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerGet403Response {
...
export function PlayerGet403ResponseToJSON(value?: PlayerGet403Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
