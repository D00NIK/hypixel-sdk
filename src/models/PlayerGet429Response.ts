 ...
 * 
 * @export
 * @interface PlayerGet429Response
 */
export interface PlayerGet429Response {
    /**
     * 
     * @type {boolean}
     * @memberof PlayerGet429Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the PlayerGet429Response interface.
 */
export function instanceOfPlayerGet429Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlayerGet429ResponseFromJSON(json: any): PlayerGet429Response {
    return PlayerGet429ResponseFromJSONTyped(json, false);
}

export function PlayerGet429ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerGet429Response {
    ...
    return {
        ...
        'throttle': !exists(json, 'throttle') ? undefined : json['throttle'],
        'global': !exists(json, 'global') ? undefined : json['global'],
    };
}

export function PlayerGet429ResponseToJSON(value?: PlayerGet429Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
