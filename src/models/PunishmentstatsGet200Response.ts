 ...
 * 
 * @export
 * @interface PunishmentstatsGet200Response
 */
export interface PunishmentstatsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof PunishmentstatsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the PunishmentstatsGet200Response interface.
 */
export function instanceOfPunishmentstatsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PunishmentstatsGet200ResponseFromJSON(json: any): PunishmentstatsGet200Response {
    return PunishmentstatsGet200ResponseFromJSONTyped(json, false);
}

export function PunishmentstatsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PunishmentstatsGet200Response {
    ...
    return {
        ...
        'watchdogLastMinute': !exists(json, 'watchdog_lastMinute') ? undefined : json['watchdog_lastMinute'],
        'staffRollingDaily': !exists(json, 'staff_rollingDaily') ? undefined : json['staff_rollingDaily'],
        'watchdogTotal': !exists(json, 'watchdog_total') ? undefined : json['watchdog_total'],
        'watchdogRollingDaily': !exists(json, 'watchdog_rollingDaily') ? undefined : json['watchdog_rollingDaily'],
        'staffTotal': !exists(json, 'staff_total') ? undefined : json['staff_total'],
    };
}

export function PunishmentstatsGet200ResponseToJSON(value?: PunishmentstatsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'watchdog_lastMinute': value.watchdogLastMinute,
        'staff_rollingDaily': value.staffRollingDaily,
        'watchdog_total': value.watchdogTotal,
        'watchdog_rollingDaily': value.watchdogRollingDaily,
        'staff_total': value.staffTotal,
    };
}
