 ...
 * 
 * @export
 * @interface QueuedBoosterAllOf
 */
export interface QueuedBoosterAllOf {
    /**
     * 
     * @type {boolean}
     * @memberof QueuedBoosterAllOf
     */
    stacked?: boolean | null;
}

/**
 * Check if a given object implements the QueuedBoosterAllOf interface.
 */
export function instanceOfQueuedBoosterAllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function QueuedBoosterAllOfFromJSON(json: any): QueuedBoosterAllOf {
    return QueuedBoosterAllOfFromJSONTyped(json, false);
}

export function QueuedBoosterAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueuedBoosterAllOf {
...
export function QueuedBoosterAllOfToJSON(value?: QueuedBoosterAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
