...
import type { RecentgamesGet200ResponseGamesInner } from './RecentgamesGet200ResponseGamesInner';
import {
    RecentgamesGet200ResponseGamesInnerFromJSON,
    RecentgamesGet200ResponseGamesInnerFromJSONTyped,
    RecentgamesGet200ResponseGamesInnerToJSON,
} from './RecentgamesGet200ResponseGamesInner';

/**
 * 
 * @export
 * @interface RecentgamesGet200Response
 */
export interface RecentgamesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof RecentgamesGet200Response
     */
    success?: boolean;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<RecentgamesGet200ResponseGamesInner>}
     * @memberof RecentgamesGet200Response
     */
    games?: Array<RecentgamesGet200ResponseGamesInner>;
}

/**
 * Check if a given object implements the RecentgamesGet200Response interface.
 */
export function instanceOfRecentgamesGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RecentgamesGet200ResponseFromJSON(json: any): RecentgamesGet200Response {
    return RecentgamesGet200ResponseFromJSONTyped(json, false);
}

export function RecentgamesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecentgamesGet200Response {
    ...
    return {
        ...
        'games': !exists(json, 'games') ? undefined : ((json['games'] as Array<any>).map(RecentgamesGet200ResponseGamesInnerFromJSON)),
    };
}

export function RecentgamesGet200ResponseToJSON(value?: RecentgamesGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'uuid': value.uuid,
        'games': value.games === undefined ? undefined : ((value.games as Array<any>).map(RecentgamesGet200ResponseGamesInnerToJSON)),
    };
}
