 ...
 * 
 * @export
 * @interface RecentgamesGet200ResponseGamesInner
 */
export interface RecentgamesGet200ResponseGamesInner {
    /**
     * 
     * @type {number}
     * @memberof RecentgamesGet200ResponseGamesInner
     */
    date?: number;
    /**
     * 
...
/**
 * Check if a given object implements the RecentgamesGet200ResponseGamesInner interface.
 */
export function instanceOfRecentgamesGet200ResponseGamesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RecentgamesGet200ResponseGamesInnerFromJSON(json: any): RecentgamesGet200ResponseGamesInner {
    return RecentgamesGet200ResponseGamesInnerFromJSONTyped(json, false);
}

export function RecentgamesGet200ResponseGamesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecentgamesGet200ResponseGamesInner {
...
export function RecentgamesGet200ResponseGamesInnerToJSON(value?: RecentgamesGet200ResponseGamesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
