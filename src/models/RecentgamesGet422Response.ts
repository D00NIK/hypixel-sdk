 ...
 * 
 * @export
 * @interface RecentgamesGet422Response
 */
export interface RecentgamesGet422Response {
    /**
     * 
     * @type {boolean}
     * @memberof RecentgamesGet422Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the RecentgamesGet422Response interface.
 */
export function instanceOfRecentgamesGet422Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RecentgamesGet422ResponseFromJSON(json: any): RecentgamesGet422Response {
    return RecentgamesGet422ResponseFromJSONTyped(json, false);
}

export function RecentgamesGet422ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecentgamesGet422Response {
...
export function RecentgamesGet422ResponseToJSON(value?: RecentgamesGet422Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
