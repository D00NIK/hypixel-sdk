 ...
 * 
 * @export
 * @interface ResourcesAchievementsGet200Response
 */
export interface ResourcesAchievementsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesAchievementsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesAchievementsGet200Response interface.
 */
export function instanceOfResourcesAchievementsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesAchievementsGet200ResponseFromJSON(json: any): ResourcesAchievementsGet200Response {
    return ResourcesAchievementsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesAchievementsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesAchievementsGet200Response {
    ...
    return {
        ...
        'achievements': !exists(json, 'achievements') ? undefined : json['achievements'],
    };
}

export function ResourcesAchievementsGet200ResponseToJSON(value?: ResourcesAchievementsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
