 ...
 * 
 * @export
 * @interface ResourcesChallengesGet200Response
 */
export interface ResourcesChallengesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesChallengesGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesChallengesGet200Response interface.
 */
export function instanceOfResourcesChallengesGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesChallengesGet200ResponseFromJSON(json: any): ResourcesChallengesGet200Response {
    return ResourcesChallengesGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesChallengesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesChallengesGet200Response {
    ...
    return {
        ...
        'challenges': !exists(json, 'challenges') ? undefined : json['challenges'],
    };
}

export function ResourcesChallengesGet200ResponseToJSON(value?: ResourcesChallengesGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
