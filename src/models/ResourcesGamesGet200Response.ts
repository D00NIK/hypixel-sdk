 ...
 * 
 * @export
 * @interface ResourcesGamesGet200Response
 */
export interface ResourcesGamesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesGamesGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesGamesGet200Response interface.
 */
export function instanceOfResourcesGamesGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesGamesGet200ResponseFromJSON(json: any): ResourcesGamesGet200Response {
    return ResourcesGamesGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesGamesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesGamesGet200Response {
    ...
    return {
        ...
        'games': !exists(json, 'games') ? undefined : (mapValues(json['games'], GameFromJSON)),
    };
}

export function ResourcesGamesGet200ResponseToJSON(value?: ResourcesGamesGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'games': value.games === undefined ? undefined : (mapValues(value.games, GameToJSON)),
    };
}
