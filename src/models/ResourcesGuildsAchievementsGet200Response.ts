 ...
 * 
 * @export
 * @interface ResourcesGuildsAchievementsGet200Response
 */
export interface ResourcesGuildsAchievementsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesGuildsAchievementsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesGuildsAchievementsGet200Response interface.
 */
export function instanceOfResourcesGuildsAchievementsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesGuildsAchievementsGet200ResponseFromJSON(json: any): ResourcesGuildsAchievementsGet200Response {
    return ResourcesGuildsAchievementsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesGuildsAchievementsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesGuildsAchievementsGet200Response {
    ...
    return {
        ...
        'oneTime': !exists(json, 'one_time') ? undefined : json['one_time'],
        'tiered': !exists(json, 'tiered') ? undefined : json['tiered'],
    };
}

export function ResourcesGuildsAchievementsGet200ResponseToJSON(value?: ResourcesGuildsAchievementsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
