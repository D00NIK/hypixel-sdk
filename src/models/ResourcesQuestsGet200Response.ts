 ...
 * 
 * @export
 * @interface ResourcesQuestsGet200Response
 */
export interface ResourcesQuestsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesQuestsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesQuestsGet200Response interface.
 */
export function instanceOfResourcesQuestsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesQuestsGet200ResponseFromJSON(json: any): ResourcesQuestsGet200Response {
    return ResourcesQuestsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesQuestsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesQuestsGet200Response {
    ...
    return {
        ...
        'quests': !exists(json, 'quests') ? undefined : json['quests'],
    };
}

export function ResourcesQuestsGet200ResponseToJSON(value?: ResourcesQuestsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
