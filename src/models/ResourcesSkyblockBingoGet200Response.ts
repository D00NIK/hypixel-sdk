...
import type { ResourcesSkyblockBingoGet200ResponseGoalsInner } from './ResourcesSkyblockBingoGet200ResponseGoalsInner';
import {
    ResourcesSkyblockBingoGet200ResponseGoalsInnerFromJSON,
    ResourcesSkyblockBingoGet200ResponseGoalsInnerFromJSONTyped,
    ResourcesSkyblockBingoGet200ResponseGoalsInnerToJSON,
} from './ResourcesSkyblockBingoGet200ResponseGoalsInner';

/**
 * 
 * @export
 * @interface ResourcesSkyblockBingoGet200Response
 */
export interface ResourcesSkyblockBingoGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesSkyblockBingoGet200Response
     */
    success?: boolean;
    /**
     * 
     ...
     * @type {Array<ResourcesSkyblockBingoGet200ResponseGoalsInner>}
     * @memberof ResourcesSkyblockBingoGet200Response
     */
    goals?: Array<ResourcesSkyblockBingoGet200ResponseGoalsInner>;
}

/**
 * Check if a given object implements the ResourcesSkyblockBingoGet200Response interface.
 */
export function instanceOfResourcesSkyblockBingoGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesSkyblockBingoGet200ResponseFromJSON(json: any): ResourcesSkyblockBingoGet200Response {
    return ResourcesSkyblockBingoGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesSkyblockBingoGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesSkyblockBingoGet200Response {
    ...
    return {
        ...
        'goals': !exists(json, 'goals') ? undefined : ((json['goals'] as Array<any>).map(ResourcesSkyblockBingoGet200ResponseGoalsInnerFromJSON)),
    };
}

export function ResourcesSkyblockBingoGet200ResponseToJSON(value?: ResourcesSkyblockBingoGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'id': value.id,
        'goals': value.goals === undefined ? undefined : ((value.goals as Array<any>).map(ResourcesSkyblockBingoGet200ResponseGoalsInnerToJSON)),
    };
}
