 ...
 * 
 * @export
 * @interface ResourcesSkyblockCollectionsGet200Response
 */
export interface ResourcesSkyblockCollectionsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesSkyblockCollectionsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesSkyblockCollectionsGet200Response interface.
 */
export function instanceOfResourcesSkyblockCollectionsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesSkyblockCollectionsGet200ResponseFromJSON(json: any): ResourcesSkyblockCollectionsGet200Response {
    return ResourcesSkyblockCollectionsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesSkyblockCollectionsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesSkyblockCollectionsGet200Response {
...
export function ResourcesSkyblockCollectionsGet200ResponseToJSON(value?: ResourcesSkyblockCollectionsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
