 ...
 * 
 * @export
 * @interface ResourcesSkyblockElectionGet200Response
 */
export interface ResourcesSkyblockElectionGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesSkyblockElectionGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesSkyblockElectionGet200Response interface.
 */
export function instanceOfResourcesSkyblockElectionGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesSkyblockElectionGet200ResponseFromJSON(json: any): ResourcesSkyblockElectionGet200Response {
    return ResourcesSkyblockElectionGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesSkyblockElectionGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesSkyblockElectionGet200Response {
    ...
    return {
        ...
        'mayor': !exists(json, 'mayor') ? undefined : json['mayor'],
        'current': !exists(json, 'current') ? undefined : json['current'],
    };
}

export function ResourcesSkyblockElectionGet200ResponseToJSON(value?: ResourcesSkyblockElectionGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
