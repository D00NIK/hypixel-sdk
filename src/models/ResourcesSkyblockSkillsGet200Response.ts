 ...
 * 
 * @export
 * @interface ResourcesSkyblockSkillsGet200Response
 */
export interface ResourcesSkyblockSkillsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesSkyblockSkillsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesSkyblockSkillsGet200Response interface.
 */
export function instanceOfResourcesSkyblockSkillsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesSkyblockSkillsGet200ResponseFromJSON(json: any): ResourcesSkyblockSkillsGet200Response {
    return ResourcesSkyblockSkillsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesSkyblockSkillsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesSkyblockSkillsGet200Response {
...
export function ResourcesSkyblockSkillsGet200ResponseToJSON(value?: ResourcesSkyblockSkillsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
