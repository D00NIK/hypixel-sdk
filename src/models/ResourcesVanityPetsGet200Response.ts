 ...
 * 
 * @export
 * @interface ResourcesVanityPetsGet200Response
 */
export interface ResourcesVanityPetsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ResourcesVanityPetsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ResourcesVanityPetsGet200Response interface.
 */
export function instanceOfResourcesVanityPetsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResourcesVanityPetsGet200ResponseFromJSON(json: any): ResourcesVanityPetsGet200Response {
    return ResourcesVanityPetsGet200ResponseFromJSONTyped(json, false);
}

export function ResourcesVanityPetsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResourcesVanityPetsGet200Response {
    ...
    return {
        ...
        'rarities': !exists(json, 'rarities') ? undefined : json['rarities'],
    };
}

export function ResourcesVanityPetsGet200ResponseToJSON(value?: ResourcesVanityPetsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
