 ...
 * 
 * @export
 * @interface SkyBlockAuctionBidsInner
 */
export interface SkyBlockAuctionBidsInner {
    /**
     * 
     * @type {string}
     * @memberof SkyBlockAuctionBidsInner
     */
    auctionId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the SkyBlockAuctionBidsInner interface.
 */
export function instanceOfSkyBlockAuctionBidsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockAuctionBidsInnerFromJSON(json: any): SkyBlockAuctionBidsInner {
    return SkyBlockAuctionBidsInnerFromJSONTyped(json, false);
}

export function SkyBlockAuctionBidsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockAuctionBidsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'auctionId': !exists(json, 'auction_id') ? undefined : json['auction_id'],
...
export function SkyBlockAuctionBidsInnerToJSON(value?: SkyBlockAuctionBidsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
