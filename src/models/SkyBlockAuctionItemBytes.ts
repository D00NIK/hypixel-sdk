 ...
 * 
 * @export
 * @interface SkyBlockAuctionItemBytes
 */
export interface SkyBlockAuctionItemBytes {
    /**
     * 
     * @type {number}
     * @memberof SkyBlockAuctionItemBytes
     */
    type?: number;
    /**
     * 
...
/**
 * Check if a given object implements the SkyBlockAuctionItemBytes interface.
 */
export function instanceOfSkyBlockAuctionItemBytes(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockAuctionItemBytesFromJSON(json: any): SkyBlockAuctionItemBytes {
    return SkyBlockAuctionItemBytesFromJSONTyped(json, false);
}

export function SkyBlockAuctionItemBytesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockAuctionItemBytes {
...
export function SkyBlockAuctionItemBytesToJSON(value?: SkyBlockAuctionItemBytes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
