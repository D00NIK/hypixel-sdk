...
/**
 * Check if a given object implements the SkyBlockMuseum interface.
 */
export function instanceOfSkyBlockMuseum(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockMuseumFromJSON(json: any): SkyBlockMuseum {
    return SkyBlockMuseumFromJSONTyped(json, false);
}

export function SkyBlockMuseumFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockMuseum {
    ...
    return {
        ...
        'appraisal': !exists(json, 'appraisal') ? undefined : json['appraisal'],
        'items': !exists(json, 'items') ? undefined : json['items'],
        'special': !exists(json, 'special') ? undefined : json['special'],
    };
}

export function SkyBlockMuseumToJSON(value?: SkyBlockMuseum | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
