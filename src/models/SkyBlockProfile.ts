...
import type { SkyBlockProfileBanking } from './SkyBlockProfileBanking';
import {
    SkyBlockProfileBankingFromJSON,
    SkyBlockProfileBankingFromJSONTyped,
    SkyBlockProfileBankingToJSON,
} from './SkyBlockProfileBanking';
import type { SkyBlockProfileMembers } from './SkyBlockProfileMembers';
import {
    SkyBlockProfileMembersFromJSON,
    SkyBlockProfileMembersFromJSONTyped,
    SkyBlockProfileMembersToJSON,
} from './SkyBlockProfileMembers';
...
export interface SkyBlockProfile {
     ...
     * 
     * @type {string}
     * @memberof SkyBlockProfile
     */
    profileId?: string;
    /**
     * 
     * @type {SkyBlockProfileMembers}
     * @memberof SkyBlockProfile
     */
     ...
     * @memberof SkyBlockProfile
     */
    communityUpgrades?: object | null;
    /**
     * 
     * @type {SkyBlockProfileBanking}
     * @memberof SkyBlockProfile
     */
    banking?: SkyBlockProfileBanking | null;
    /**
     * The SkyBlock game mode of the profile, not present if normal mode
     * @type {string}
     * @memberof SkyBlockProfile
     */
    gameMode?: SkyBlockProfileGameModeEnum;
}
 ...
 * @export
 */
export const SkyBlockProfileGameModeEnum = {
    Ironman: 'ironman',
    Island: 'island',
    Bingo: 'bingo'
} as const;
export type SkyBlockProfileGameModeEnum = typeof SkyBlockProfileGameModeEnum[keyof typeof SkyBlockProfileGameModeEnum];


/**
 * Check if a given object implements the SkyBlockProfile interface.
 */
export function instanceOfSkyBlockProfile(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockProfileFromJSON(json: any): SkyBlockProfile {
    return SkyBlockProfileFromJSONTyped(json, false);
}

export function SkyBlockProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockProfile {
    ...
    return {
        ...
        'members': !exists(json, 'members') ? undefined : SkyBlockProfileMembersFromJSON(json['members']),
        'cuteName': !exists(json, 'cute_name') ? undefined : json['cute_name'],
        'selected': !exists(json, 'selected') ? undefined : json['selected'],
        'communityUpgrades': !exists(json, 'community_upgrades') ? undefined : json['community_upgrades'],
        'banking': !exists(json, 'banking') ? undefined : SkyBlockProfileBankingFromJSON(json['banking']),
        'gameMode': !exists(json, 'game_mode') ? undefined : json['game_mode'],
    };
}

export function SkyBlockProfileToJSON(value?: SkyBlockProfile | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'members': SkyBlockProfileMembersToJSON(value.members),
        'cute_name': value.cuteName,
        'selected': value.selected,
        'community_upgrades': value.communityUpgrades,
        'banking': SkyBlockProfileBankingToJSON(value.banking),
