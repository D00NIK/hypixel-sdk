 ...
 * 
 * @export
 * @interface SkyBlockProfileBankingTransactionsInner
 */
export interface SkyBlockProfileBankingTransactionsInner {
    /**
     * 
     * @type {number}
     * @memberof SkyBlockProfileBankingTransactionsInner
     */
    timestamp?: number;
    /**
     * 
     ...
     * @memberof SkyBlockProfileBankingTransactionsInner
     */
    action?: SkyBlockProfileBankingTransactionsInnerActionEnum;
    /**
     * 
     * @type {string}
     * @memberof SkyBlockProfileBankingTransactionsInner
 ...
 * @export
 */
export const SkyBlockProfileBankingTransactionsInnerActionEnum = {
    Deposit: 'DEPOSIT',
    Withdraw: 'WITHDRAW'
} as const;
export type SkyBlockProfileBankingTransactionsInnerActionEnum = typeof SkyBlockProfileBankingTransactionsInnerActionEnum[keyof typeof SkyBlockProfileBankingTransactionsInnerActionEnum];


/**
 * Check if a given object implements the SkyBlockProfileBankingTransactionsInner interface.
 */
export function instanceOfSkyBlockProfileBankingTransactionsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockProfileBankingTransactionsInnerFromJSON(json: any): SkyBlockProfileBankingTransactionsInner {
    return SkyBlockProfileBankingTransactionsInnerFromJSONTyped(json, false);
}

export function SkyBlockProfileBankingTransactionsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockProfileBankingTransactionsInner {
    ...
    return {
        ...
        'initiatorName': !exists(json, 'initiator_name') ? undefined : json['initiator_name'],
        'amount': !exists(json, 'amount') ? undefined : json['amount'],
    };
}

export function SkyBlockProfileBankingTransactionsInnerToJSON(value?: SkyBlockProfileBankingTransactionsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'action': value.action,
        'initiator_name': value.initiatorName,
        'amount': value.amount,
    };
}
