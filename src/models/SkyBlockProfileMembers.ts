...
import type { SkyBlockProfileMembersDeletionNotice } from './SkyBlockProfileMembersDeletionNotice';
import {
    SkyBlockProfileMembersDeletionNoticeFromJSON,
    SkyBlockProfileMembersDeletionNoticeFromJSONTyped,
    SkyBlockProfileMembersDeletionNoticeToJSON,
} from './SkyBlockProfileMembersDeletionNotice';

/**
 * A map of member UUIDs to member profiles objects
 * @export
 * @interface SkyBlockProfileMembers
 */
export interface SkyBlockProfileMembers {
    /**
     * 
     * @type {string}
     * @memberof SkyBlockProfileMembers
     */
    playerId?: string;
    /**
     * 
     * @type {SkyBlockProfileMembersDeletionNotice}
     * @memberof SkyBlockProfileMembers
     */
    deletionNotice?: SkyBlockProfileMembersDeletionNotice | null;
}

/**
 * Check if a given object implements the SkyBlockProfileMembers interface.
 */
export function instanceOfSkyBlockProfileMembers(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockProfileMembersFromJSON(json: any): SkyBlockProfileMembers {
    return SkyBlockProfileMembersFromJSONTyped(json, false);
}

export function SkyBlockProfileMembersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockProfileMembers {
    ...
    return {
        ...
        'deletionNotice': !exists(json, 'deletion_notice') ? undefined : SkyBlockProfileMembersDeletionNoticeFromJSON(json['deletion_notice']),
    };
}

export function SkyBlockProfileMembersToJSON(value?: SkyBlockProfileMembers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deletion_notice': SkyBlockProfileMembersDeletionNoticeToJSON(value.deletionNotice),
    };
}
