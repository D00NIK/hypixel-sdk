 ...
 * @export
 * @interface SkyBlockProfileMembersDeletionNotice
 */
export interface SkyBlockProfileMembersDeletionNotice {
    /**
     * 
     * @type {number}
     * @memberof SkyBlockProfileMembersDeletionNotice
     */
    timestamp?: number;
}

/**
 * Check if a given object implements the SkyBlockProfileMembersDeletionNotice interface.
 */
export function instanceOfSkyBlockProfileMembersDeletionNotice(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyBlockProfileMembersDeletionNoticeFromJSON(json: any): SkyBlockProfileMembersDeletionNotice {
    return SkyBlockProfileMembersDeletionNoticeFromJSONTyped(json, false);
}

export function SkyBlockProfileMembersDeletionNoticeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyBlockProfileMembersDeletionNotice {
...
export function SkyBlockProfileMembersDeletionNoticeToJSON(value?: SkyBlockProfileMembersDeletionNotice | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
