 ...
 * 
 * @export
 * @interface SkyblockAuctionGet200Response
 */
export interface SkyblockAuctionGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockAuctionGet200Response interface.
 */
export function instanceOfSkyblockAuctionGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionGet200ResponseFromJSON(json: any): SkyblockAuctionGet200Response {
    return SkyblockAuctionGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionGet200Response {
...
export function SkyblockAuctionGet200ResponseToJSON(value?: SkyblockAuctionGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
