 ...
 * 
 * @export
 * @interface SkyblockAuctionsEndedGet200Response
 */
export interface SkyblockAuctionsEndedGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionsEndedGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockAuctionsEndedGet200Response interface.
 */
export function instanceOfSkyblockAuctionsEndedGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionsEndedGet200ResponseFromJSON(json: any): SkyblockAuctionsEndedGet200Response {
    return SkyblockAuctionsEndedGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionsEndedGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionsEndedGet200Response {
    ...
    return {
        ...
        'auctions': !exists(json, 'auctions') ? undefined : json['auctions'],
    };
}

export function SkyblockAuctionsEndedGet200ResponseToJSON(value?: SkyblockAuctionsEndedGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
