...
import type { SkyBlockAuction } from './SkyBlockAuction';
import {
    SkyBlockAuctionFromJSON,
    SkyBlockAuctionFromJSONTyped,
    SkyBlockAuctionToJSON,
} from './SkyBlockAuction';

/**
 * 
 * @export
 * @interface SkyblockAuctionsGet200Response
 */
export interface SkyblockAuctionsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionsGet200Response
     */
    success?: boolean;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<SkyBlockAuction>}
     * @memberof SkyblockAuctionsGet200Response
     */
    auctions?: Array<SkyBlockAuction>;
}

/**
 * Check if a given object implements the SkyblockAuctionsGet200Response interface.
 */
export function instanceOfSkyblockAuctionsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionsGet200ResponseFromJSON(json: any): SkyblockAuctionsGet200Response {
    return SkyblockAuctionsGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionsGet200Response {
    ...
    return {
        ...
        'totalAuctions': !exists(json, 'totalAuctions') ? undefined : json['totalAuctions'],
        'lastUpdated': !exists(json, 'lastUpdated') ? undefined : json['lastUpdated'],
        'auctions': !exists(json, 'auctions') ? undefined : ((json['auctions'] as Array<any>).map(SkyBlockAuctionFromJSON)),
    };
}

export function SkyblockAuctionsGet200ResponseToJSON(value?: SkyblockAuctionsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'totalAuctions': value.totalAuctions,
        'lastUpdated': value.lastUpdated,
        'auctions': value.auctions === undefined ? undefined : ((value.auctions as Array<any>).map(SkyBlockAuctionToJSON)),
    };
}
