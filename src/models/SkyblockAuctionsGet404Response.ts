 ...
 * 
 * @export
 * @interface SkyblockAuctionsGet404Response
 */
export interface SkyblockAuctionsGet404Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionsGet404Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockAuctionsGet404Response interface.
 */
export function instanceOfSkyblockAuctionsGet404Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionsGet404ResponseFromJSON(json: any): SkyblockAuctionsGet404Response {
    return SkyblockAuctionsGet404ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionsGet404ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionsGet404Response {
...
export function SkyblockAuctionsGet404ResponseToJSON(value?: SkyblockAuctionsGet404Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
