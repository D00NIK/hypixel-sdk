 ...
 * 
 * @export
 * @interface SkyblockAuctionsGet422Response
 */
export interface SkyblockAuctionsGet422Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionsGet422Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockAuctionsGet422Response interface.
 */
export function instanceOfSkyblockAuctionsGet422Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionsGet422ResponseFromJSON(json: any): SkyblockAuctionsGet422Response {
    return SkyblockAuctionsGet422ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionsGet422ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionsGet422Response {
...
export function SkyblockAuctionsGet422ResponseToJSON(value?: SkyblockAuctionsGet422Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
