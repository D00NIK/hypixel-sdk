 ...
 * 
 * @export
 * @interface SkyblockAuctionsGet503Response
 */
export interface SkyblockAuctionsGet503Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockAuctionsGet503Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockAuctionsGet503Response interface.
 */
export function instanceOfSkyblockAuctionsGet503Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockAuctionsGet503ResponseFromJSON(json: any): SkyblockAuctionsGet503Response {
    return SkyblockAuctionsGet503ResponseFromJSONTyped(json, false);
}

export function SkyblockAuctionsGet503ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockAuctionsGet503Response {
...
export function SkyblockAuctionsGet503ResponseToJSON(value?: SkyblockAuctionsGet503Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
