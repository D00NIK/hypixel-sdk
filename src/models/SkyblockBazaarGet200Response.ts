 ...
 * 
 * @export
 * @interface SkyblockBazaarGet200Response
 */
export interface SkyblockBazaarGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockBazaarGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockBazaarGet200Response interface.
 */
export function instanceOfSkyblockBazaarGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockBazaarGet200ResponseFromJSON(json: any): SkyblockBazaarGet200Response {
    return SkyblockBazaarGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockBazaarGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockBazaarGet200Response {
...
export function SkyblockBazaarGet200ResponseToJSON(value?: SkyblockBazaarGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
