...
import type { SkyblockBingoGet200ResponseEventsInner } from './SkyblockBingoGet200ResponseEventsInner';
import {
    SkyblockBingoGet200ResponseEventsInnerFromJSON,
    SkyblockBingoGet200ResponseEventsInnerFromJSONTyped,
    SkyblockBingoGet200ResponseEventsInnerToJSON,
} from './SkyblockBingoGet200ResponseEventsInner';

/**
 * 
 * @export
 * @interface SkyblockBingoGet200Response
 */
export interface SkyblockBingoGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockBingoGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<SkyblockBingoGet200ResponseEventsInner>}
     * @memberof SkyblockBingoGet200Response
     */
    events?: Array<SkyblockBingoGet200ResponseEventsInner>;
}

/**
 * Check if a given object implements the SkyblockBingoGet200Response interface.
 */
export function instanceOfSkyblockBingoGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockBingoGet200ResponseFromJSON(json: any): SkyblockBingoGet200Response {
    return SkyblockBingoGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockBingoGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockBingoGet200Response {
    ...
    return {
        ...
        'events': !exists(json, 'events') ? undefined : ((json['events'] as Array<any>).map(SkyblockBingoGet200ResponseEventsInnerFromJSON)),
    };
}

export function SkyblockBingoGet200ResponseToJSON(value?: SkyblockBingoGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'events': value.events === undefined ? undefined : ((value.events as Array<any>).map(SkyblockBingoGet200ResponseEventsInnerToJSON)),
    };
}
