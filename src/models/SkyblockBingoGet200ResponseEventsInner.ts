 ...
 * 
 * @export
 * @interface SkyblockBingoGet200ResponseEventsInner
 */
export interface SkyblockBingoGet200ResponseEventsInner {
    /**
     * The id for this event
     * @type {number}
     * @memberof SkyblockBingoGet200ResponseEventsInner
     */
    key: number;
    /**
...
/**
 * Check if a given object implements the SkyblockBingoGet200ResponseEventsInner interface.
 */
export function instanceOfSkyblockBingoGet200ResponseEventsInner(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "key" in value;
    isInstance = isInstance && "points" in value;
    isInstance = isInstance && "completedGoals" in value;

    return isInstance;
}

export function SkyblockBingoGet200ResponseEventsInnerFromJSON(json: any): SkyblockBingoGet200ResponseEventsInner {
    return SkyblockBingoGet200ResponseEventsInnerFromJSONTyped(json, false);
}

export function SkyblockBingoGet200ResponseEventsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockBingoGet200ResponseEventsInner {
...
export function SkyblockBingoGet200ResponseEventsInnerToJSON(value?: SkyblockBingoGet200ResponseEventsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'key': value.key,
        'points': value.points,
        'completed_goals': value.completedGoals,
    };
}
