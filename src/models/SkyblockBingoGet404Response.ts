 ...
 * 
 * @export
 * @interface SkyblockBingoGet404Response
 */
export interface SkyblockBingoGet404Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockBingoGet404Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockBingoGet404Response interface.
 */
export function instanceOfSkyblockBingoGet404Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockBingoGet404ResponseFromJSON(json: any): SkyblockBingoGet404Response {
    return SkyblockBingoGet404ResponseFromJSONTyped(json, false);
}

export function SkyblockBingoGet404ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockBingoGet404Response {
...
export function SkyblockBingoGet404ResponseToJSON(value?: SkyblockBingoGet404Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
