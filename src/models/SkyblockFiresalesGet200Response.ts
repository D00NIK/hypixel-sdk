...
import type { SkyBlockFireSale } from './SkyBlockFireSale';
import {
    SkyBlockFireSaleFromJSON,
    SkyBlockFireSaleFromJSONTyped,
    SkyBlockFireSaleToJSON,
} from './SkyBlockFireSale';

/**
 * 
 * @export
 * @interface SkyblockFiresalesGet200Response
 */
export interface SkyblockFiresalesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockFiresalesGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<SkyBlockFireSale>}
     * @memberof SkyblockFiresalesGet200Response
     */
    sales?: Array<SkyBlockFireSale>;
}

/**
 * Check if a given object implements the SkyblockFiresalesGet200Response interface.
 */
export function instanceOfSkyblockFiresalesGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockFiresalesGet200ResponseFromJSON(json: any): SkyblockFiresalesGet200Response {
    return SkyblockFiresalesGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockFiresalesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockFiresalesGet200Response {
    ...
    return {
        ...
        'sales': !exists(json, 'sales') ? undefined : ((json['sales'] as Array<any>).map(SkyBlockFireSaleFromJSON)),
    };
}

export function SkyblockFiresalesGet200ResponseToJSON(value?: SkyblockFiresalesGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sales': value.sales === undefined ? undefined : ((value.sales as Array<any>).map(SkyBlockFireSaleToJSON)),
    };
}
