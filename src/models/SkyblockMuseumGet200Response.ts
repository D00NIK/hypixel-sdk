...
import type { SkyBlockMuseum } from './SkyBlockMuseum';
import {
    SkyBlockMuseumFromJSON,
    SkyBlockMuseumFromJSONTyped,
    SkyBlockMuseumToJSON,
} from './SkyBlockMuseum';

/**
 * 
 * @export
 * @interface SkyblockMuseumGet200Response
 */
export interface SkyblockMuseumGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockMuseumGet200Response
     */
    success?: boolean;
    /**
     * 
     ...
     * @memberof SkyblockMuseumGet200Response
     */
    profile?: SkyBlockMuseum;
}

/**
 * Check if a given object implements the SkyblockMuseumGet200Response interface.
 */
export function instanceOfSkyblockMuseumGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockMuseumGet200ResponseFromJSON(json: any): SkyblockMuseumGet200Response {
    return SkyblockMuseumGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockMuseumGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockMuseumGet200Response {
    ...
    return {
        ...
        'profile': !exists(json, 'profile') ? undefined : SkyBlockMuseumFromJSON(json['profile']),
    };
}

export function SkyblockMuseumGet200ResponseToJSON(value?: SkyblockMuseumGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'profile': SkyBlockMuseumToJSON(value.profile),
    };
}
