 ...
 * 
 * @export
 * @interface SkyblockNewsGet200Response
 */
export interface SkyblockNewsGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockNewsGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockNewsGet200Response interface.
 */
export function instanceOfSkyblockNewsGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockNewsGet200ResponseFromJSON(json: any): SkyblockNewsGet200Response {
    return SkyblockNewsGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockNewsGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockNewsGet200Response {
...
export function SkyblockNewsGet200ResponseToJSON(value?: SkyblockNewsGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
