 ...
 * 
 * @export
 * @interface SkyblockProfileGet200Response
 */
export interface SkyblockProfileGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockProfileGet200Response
     */
    success?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the SkyblockProfileGet200Response interface.
 */
export function instanceOfSkyblockProfileGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockProfileGet200ResponseFromJSON(json: any): SkyblockProfileGet200Response {
    return SkyblockProfileGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockProfileGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockProfileGet200Response {
    ...
    return {
        ...
        'profile': !exists(json, 'profile') ? undefined : SkyBlockProfileFromJSON(json['profile']),
    };
}

export function SkyblockProfileGet200ResponseToJSON(value?: SkyblockProfileGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'profile': SkyBlockProfileToJSON(value.profile),
    };
}
