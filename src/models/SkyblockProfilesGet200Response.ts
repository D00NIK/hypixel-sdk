...
import {
    SkyBlockProfileFromJSON,
    SkyBlockProfileFromJSONTyped,
    SkyBlockProfileToJSON,
} from './SkyBlockProfile';

/**
 * 
 * @export
 * @interface SkyblockProfilesGet200Response
 */
export interface SkyblockProfilesGet200Response {
    /**
     * 
     * @type {boolean}
     * @memberof SkyblockProfilesGet200Response
     */
    success?: boolean;
    /**
     * 
     * @type {Array<SkyBlockProfile>}
     * @memberof SkyblockProfilesGet200Response
     */
    profiles?: Array<SkyBlockProfile>;
}

/**
 * Check if a given object implements the SkyblockProfilesGet200Response interface.
 */
export function instanceOfSkyblockProfilesGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SkyblockProfilesGet200ResponseFromJSON(json: any): SkyblockProfilesGet200Response {
    return SkyblockProfilesGet200ResponseFromJSONTyped(json, false);
}

export function SkyblockProfilesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SkyblockProfilesGet200Response {
    ...
    return {
        ...
        'profiles': !exists(json, 'profiles') ? undefined : ((json['profiles'] as Array<any>).map(SkyBlockProfileFromJSON)),
    };
}

export function SkyblockProfilesGet200ResponseToJSON(value?: SkyblockProfilesGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'profiles': value.profiles === undefined ? undefined : ((value.profiles as Array<any>).map(SkyBlockProfileToJSON)),
    };
}
