...
import type { StatusGet200ResponseSession } from './StatusGet200ResponseSession';
import {
    StatusGet200ResponseSessionFromJSON,
    StatusGet200ResponseSessionFromJSONTyped,
    StatusGet200ResponseSessionToJSON,
} from './StatusGet200ResponseSession';
...
export interface StatusGet200Response {
    ...
    /**
     * 
     * @type {StatusGet200ResponseSession}
     * @memberof StatusGet200Response
     */
    session?: StatusGet200ResponseSession;
}

/**
 * Check if a given object implements the StatusGet200Response interface.
 */
export function instanceOfStatusGet200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StatusGet200ResponseFromJSON(json: any): StatusGet200Response {
    return StatusGet200ResponseFromJSONTyped(json, false);
}

export function StatusGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusGet200Response {
    ...
    return {
        ...
        'session': !exists(json, 'session') ? undefined : StatusGet200ResponseSessionFromJSON(json['session']),
    };
}

export function StatusGet200ResponseToJSON(value?: StatusGet200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'uuid': value.uuid,
        'session': StatusGet200ResponseSessionToJSON(value.session),
    };
}
