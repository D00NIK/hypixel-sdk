 ...
 * 
 * @export
 * @interface StatusGet200ResponseSession
 */
export interface StatusGet200ResponseSession {
    /**
     * 
     * @type {boolean}
     * @memberof StatusGet200ResponseSession
     */
    online?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the StatusGet200ResponseSession interface.
 */
export function instanceOfStatusGet200ResponseSession(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StatusGet200ResponseSessionFromJSON(json: any): StatusGet200ResponseSession {
    return StatusGet200ResponseSessionFromJSONTyped(json, false);
}

export function StatusGet200ResponseSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusGet200ResponseSession {
...
export function StatusGet200ResponseSessionToJSON(value?: StatusGet200ResponseSession | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
